Rails.application.routes.draw do
  ...
  resources :product_models, only: [:show, :new, :create, :edit, :update, :index, :destroy] do
    patch :disabled, on: :collection
    patch :activate, on: :collection
    get :show_disabled, on: :collection
  end
